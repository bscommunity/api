...
fun Application.configureRouting() {
    ...
    routing {
        ...
        tourPassRoutes(tourPassRepository, userRepository, uploadService, tourPassPublishService)
        themeRoutes(themeRepository, uploadService, userRepository, themePublishService)
