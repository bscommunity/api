...
object VersionMapper {
    /**
     * Maps a [org.jetbrains.exposed.sql.ResultRow] to a [org.bscm.models.Version].
     *
     * [index] must always be provided by the caller — never computed here.
     * This keeps mapping pure and free of extra queries.
     */
    fun rowToVersion(row: ResultRow, index: Int): Version = Version(
    ...
    fun entityToVersion(entity: VersionEntity, index: Int): Version = Version(
